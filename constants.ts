...
export const TEST_PAPERS: TestPaper[] = [
  ...
  { id: 'l1', title: 'Rajyaseva GS-1 Full Paper', category: 'LONG', questionsCount: 150, durationMinutes: 120 },
  { id: 'q1', title: 'Daily History Quiz', category: 'QUIZ', questionsCount: 10, durationMinutes: 5 },
];
...
export const MOCK_PYQ_PDFS: PYQPdf[] = [
  ...
  // 2024
  { 
    id: 'rj-2024-p1', year: 2024, title: 'Rajyaseva Prelims 2024 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2024_GS.pdf',
  ...
  // 2023
  { 
    id: 'rj-2023-p1', year: 2023, title: 'Rajyaseva Prelims 2023 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2023_GS.pdf',
  ...
  // 2022
  { 
    id: 'rj-2022-p1', year: 2022, title: 'Rajyaseva Prelims 2022 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2022_GS.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1S_xD6ohdaJjriJ2nGIIEoF1J0iqsYYr3/view?usp=drive_link'
  },
  { 
    id: 'rj-2022-p2', year: 2022, title: 'Rajyaseva Prelims 2022 CSAT', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2022_CSAT.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1s2PAm860E32cAuGTGIxhDnwSX1sf4rGv/view?usp=drive_link'
  },

  // 2021
  { 
    id: 'rj-2021-p1', year: 2021, title: 'Rajyaseva Prelims 2021 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2021_GS.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1l3byo4kHtiC-KSIa2sfeEmbTagDMAppW/view?usp=drive_link'
  },
  { 
    id: 'rj-2021-p2', year: 2021, title: 'Rajyaseva Prelims 2021 CSAT', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2021_CSAT.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1n93geJyQewtUb4erdfIR4VFR8epDrmAD/view?usp=drive_link'
  },

  // 2020
  { 
    id: 'rj-2020-p1', year: 2020, title: 'Rajyaseva Prelims 2020 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2020_GS.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1ih2azxRwSWkWLLuoUJSx3Eydhnb03u5k/view?usp=drive_link'
  },
  { 
    id: 'rj-2020-p2', year: 2020, title: 'Rajyaseva Prelims 2020 CSAT', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2020_CSAT.pdf',
    downloadUrl: 'https://drive.google.com/file/d/15dUgF7lSLYTfMYD8shW71nkKKgzLniUv/view?usp=drive_link'
  },

  // 2019
  { 
    id: 'rj-2019-p1', year: 2019, title: 'Rajyaseva Prelims 2019 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2019_GS.pdf',
  ...
  { 
    id: 'rj-2018-p2', year: 2018, title: 'Rajyaseva Prelims 2018 CSAT', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2018_CSAT.pdf',
    downloadUrl: 'https://drive.google.com/file/d/18DtniSMfP8NyLBtxm9xJkaY35eCxCd_5/view?usp=drive_link'
  },

  // 2017
  { 
    id: 'rj-2017-p1', year: 2017, title: 'Rajyaseva Prelims 2017 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2017_GS.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1HD0EGKzR4EzuGp6efMHuTUlv1mw-6rj8/view?usp=drive_link'
  },
  { 
    id: 'rj-2017-p2', year: 2017, title: 'Rajyaseva Prelims 2017 CSAT', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2017_CSAT.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1AjZFKvGzHbv5uLBfCho3DhNmS_Wgaa2T/view?usp=drive_link'
  },

  // 2016
  { 
    id: 'rj-2016-p1', year: 2016, title: 'Rajyaseva Prelims 2016 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2016_GS.pdf',
  ...
  // 2015
  { 
    id: 'rj-2015-p1', year: 2015, title: 'Rajyaseva Prelims 2015 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2015_GS.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1PRpT9muH697D8HLWxRxwGTKPlj3CtnpL/view?usp=drive_link'
  },
  { 
    id: 'rj-2015-p2', year: 2015, title: 'Rajyaseva Prelims 2015 CSAT', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2015_CSAT.pdf',
  ...
  { 
    id: 'rj-2014-p2', year: 2014, title: 'Rajyaseva Prelims 2014 CSAT', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2014_CSAT.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1TqOM28yZT24_gTx_CGijCg4_dYG0YeQA/view?usp=drive_link'
  },

  // 2013
  { 
    id: 'rj-2013-p1', year: 2013, title: 'Rajyaseva Prelims 2013 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2013_GS.pdf',
    downloadUrl: 'https://drive.google.com/file/d/160t-JDqbkkqx7gEhHYkXdgYBbt9GQ5u-/view?usp=drive_link'
  },
  { 
    id: 'rj-2013-p2', year: 2013, title: 'Rajyaseva Prelims 2013 CSAT', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2013_CSAT.pdf',
    downloadUrl: 'https://drive.google.com/file/d/10s8WvFYDmpOjTuMTsqdvnUZoUpl9SlY0/view?usp=drive_link'
  },

  // 2012
  { 
    id: 'rj-2012-p1', year: 2012, title: 'Rajyaseva Prelims 2012 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2012_GS.pdf',
    downloadUrl: 'https://drive.google.com/file/d/1qbRGrBxQCNTJ_FoZDReWGXF1Z9ul9-Q5/view?usp=drive_link'
  },

  // 2011
  { 
    id: 'rj-2011-p1', year: 2011, title: 'Rajyaseva Prelims 2011 GS', examType: 'Rajyaseva', paperType: 'Prelims', fileName: 'Rajyaseva_Pre_2011_GS.pdf',
